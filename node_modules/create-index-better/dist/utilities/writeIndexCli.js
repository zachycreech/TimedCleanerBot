...
exports.default = function (directoryPaths) {
  ...
  sortedDirectoryPaths = sortedDirectoryPaths.filter(directoryPath => {
    return (0, _validateTargetDirectory2.default)(directoryPath, {
      ext,
  ...
  _lodash2.default.forEach(sortedDirectoryPaths, directoryPath => {
    ...
    const config = (0, _readIndexConfig2.default)(directoryPath, ext, JSON.parse(options.defaultConfig || '{}'));
    ...
    const indexFilePath = _path2.default.resolve(directoryPath, 'index.' + ext);
    ...
    const initCode = existingIndexCode.split(_constants.CREATE_INDEX_PATTERN)[0] || '';
